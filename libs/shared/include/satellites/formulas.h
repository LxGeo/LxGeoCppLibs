...
namespace LxGeo
{
    namespace GeometryFactoryShared
    {
        ...
        double compute_rotation_angle(const double& satAz1_r, const double& satEl1_r, const double& satAz2_r, const double& satEl2_r) {
        ...
        std::pair<double, double> compute_roof2roof_constants(const double& satAz1_r, const double& satEl1_r, const double& satAz2_r, const double& satEl2_r) {
