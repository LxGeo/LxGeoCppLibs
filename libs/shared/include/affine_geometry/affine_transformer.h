...
namespace LxGeo
{
	namespace GeometryFactoryShared
	{
		...
		LX_GEO_FACTORY_SHARED_API geometry_type translate_geometry(geometry_type& in_geometry, bg::strategy::transform::translate_transformer<double, 2, 2>& trans_obj) {
		...
		template<typename geometry_type>
		LX_GEO_FACTORY_SHARED_API std::vector<geometry_type> translate_geometries(std::vector<geometry_type>& input_container, std::vector<SpatialCoords>& displacement_container) {
		...
		template<typename geometry_type>
		LX_GEO_FACTORY_SHARED_API std::list<geometry_type> translate_geometries(std::list<geometry_type>& input_container, std::list<SpatialCoords>& displacement_container) {
		...
		*/
		template<typename geometry_type>
		LX_GEO_FACTORY_SHARED_API std::vector<geometry_type> affine_transform_geometries(std::vector<geometry_type>& input_container,
		...
		LX_GEO_FACTORY_SHARED_API out_geometry_type affine_transform_geometry(in_geometry_type& in_geometry, bg::strategy::transform::matrix_transformer<double, 2, 2>& trans_obj) {
