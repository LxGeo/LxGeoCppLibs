...
namespace LxGeo
{
	namespace GeometryFactoryShared
	{
		...
		bg::strategy::transform::matrix_transformer<double, 2, 2> geotransform_to_matrix_transformer(const double geotransform[6], double x_shift, double y_shift) {
		...
		bg::strategy::transform::inverse_transformer<double, 2, 2> geotransform_to_inv_matrix_transformer(const double geotransform[6]) {
